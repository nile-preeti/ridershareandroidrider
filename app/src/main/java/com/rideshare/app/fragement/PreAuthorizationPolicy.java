...
public class PreAuthorizationPolicy extends Fragment {
    private View rootView;
    final static String URL = BASE_URL + "pre-authorized-policy";

    public PreAuthorizationPolicy() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_pre_authorization_policy, container, false);
        setHasOptionsMenu(true);
        ((HomeActivity) getActivity()).fontToTitleBar("PreAuthorization Policy");
        WebView webView = rootView.findViewById(R.id.webview_preauthorization_policy);
        // Enable Javascript
